...
export default {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      '5xl' : '0px 109.011px 43.7635px rgba(53, 114, 141, 0.01), 0px 61.2688px 36.6022px rgba(53, 114, 141, 0.03), 0px 27.0538px 27.0538px rgba(53, 114, 141, 0.04), 0px 7.16129px 15.1183px rgba(53, 114, 141, 0.05)',
    },
    colors: {
      white: {
        100: '#F7F7F7',
