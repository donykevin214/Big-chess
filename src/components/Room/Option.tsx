      ...
      <div className="flex flex-col justify-between gap-2 p-4">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="flex gap-2 justify-center">
            {timeMode === 1 ? (
              <TimeItem time="10 min" time_mode={1} activated={true} />
            ) : (
              <TimeItem time="10 min" time_mode={1} activated={false} />
            )}
            {timeMode === 2 ? (
              <TimeItem time="15/10" time_mode={2} activated={true} />
            ) : (
              <TimeItem time="15/10" time_mode={2} activated={false} />
            )}
            {timeMode === 3 ? (
              <TimeItem time="30 min" time_mode={3} activated={true} />
            ) : (
              <TimeItem time="30 min" time_mode={3} activated={false} />
            )}
          </div>
        </div>
